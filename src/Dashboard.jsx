      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-lg sm:rounded-2xl shadow-xl p-4 sm:p-6 mt-4 sm:mt-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
            <button className="p-3 sm:p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors duration-200 text-left">
            ...
            <button className="p-3 sm:p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors duration-200 text-left">
            ...
            <button className="p-3 sm:p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors duration-200 text-left">
            ...
            <button className="p-3 sm:p-4 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors duration-200 text-left">
