...
const Homepage = () => {
  ...
  const BookStorePage = () => {
    ...
    const handleGoBack = () => {
      // Navigate to Dashboard.jsx file
      window.location.href = '/dashboard';
      // Or if using hash routing: window.location.hash = '#/dashboard';
    };
      ...
      <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden">
        <div className="relative">
          ...
          <button
            ...
            className={`absolute top-2 sm:top-3 right-2 sm:right-3 p-2 rounded-full transition-colors touch-manipulation ${wishlist.includes(book.id)
